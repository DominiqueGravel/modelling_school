...
%------------------------------
	...
	\begin{frame}{Euler method}
		...
		$C^{t+\Delta t} \approxeq C^t + \Delta t\frac{dC^t}{dt} + O(\Delta t)$
		\vskip 1em
...
%------------------------------
	...
	\begin{frame}{Exercise 2}
		\begin{itemize}
			\item Program a function to integrate the logistic growth modelwith the Euler method between $t_0$ and $t_100$ and with $N_0 = 0.1$, $r = 1$ $ K = 1$\\
